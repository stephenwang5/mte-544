...
The remaning part of this manual can be done in lab or at home. But it is recommended that you perform some plots to check the quality of the data before leaving the lab. You will not be able to recollect the data at another time if you did not perform this check.
...
By running the script, you will be able to create plots for the data collected. These plots should help you with your discussions at the end of this manual.
